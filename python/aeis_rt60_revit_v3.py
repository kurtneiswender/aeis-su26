# -*- coding: utf-8 -*-
# VERSION: v3 — ray trace (sentinel inject) + .html auto-extension
"""
...
def save_html_report(room_name, volume_m3, surface_data, rt60_sabine, rt60_eyring,
    ...
    if ray_svg:
        ray_section = (
            "<h2>Ray Trace — 2D Plan</h2>\n"
            "<p class=\"note\">Overhead plan view. "
            "Source at room centroid (red dot). "
            "Color encodes energy: red = full → blue = absorbed. "
            "Mean α at 500 Hz used for all surfaces.</p>\n"
            + ray_svg
        )
    else:
        ray_section = ""
